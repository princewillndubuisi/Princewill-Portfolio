export const myProjects = [
  {
    ...
    href: "https://prince-cocktail.vercel.app/",
    logo: "#",
  },

  {
    id: 2,
    title: "Apple M4 Interactive Experience",
    description:
      "A premium Apple-inspired landing page built with React, Three.js, GSAP, and Tailwind CSS, featuring cinematic animations, immersive visuals, and smooth scroll-driven interactions.",
    subdescription: [
      "Developed a highly interactive Apple-style product showcase with modern UI/UX principles.",
      "Integrated Three.js for immersive 3D visual experiences and enhanced product presentation.",
      "Implemented GSAP-powered animations, scroll-triggered effects, and smooth content reveals.",
      "Created dynamic text and logo masking effects with engaging visual storytelling techniques.",
    ],
...

  {
    ...
    description:
      "A fast, responsive blog for news and career updates built with Laravel and Tailwind.",
    subdescription: [
      "Livewire enables instant search and category filtering.",
      "Tailwind ensures clean, mobile-first design.",
      "Admin tools support content and job post management.",
      "Includes a dedicated job board for career seekers.",
    ],
